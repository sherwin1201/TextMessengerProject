...
class Register:
    def __init__(self,root):
        ...
        title = Label(frame1,text="Register Here!!",font=("times new roman",25,"bold"),bg="white",fg="blue").place(x=50,y=30)
        ...
        #for last name 
        l_name = Label(frame1,text="Last Name",font=("times new roman",15,"bold"),bg="white",fg = "black").place(x=400,y=60)
        self.txt_lname = Entry(frame1,font=("times new roman",15),bg = "lightgray")
        self.txt_lname.place(x=400,y=90,width=250)
        
        #for contact number 
        c_num = Label(frame1,text="Contact Number",font=("times new roman",15,"bold"),bg="white",fg="black").place(x=50,y=130)
        ...
        e_mail = Label(frame1,text="Email Address",font = ("times new roman",15,"bold"),bg="white",fg="black").place(x=400,y=150)
        ...
        s_quest= Label(frame1,text="Select Security Question",font = ("times new roman",15,"bold"),bg="white",fg="black").place(x=50,y=220)
        ...
        answer = Label(frame1,text="Answer",font = ("times new roman",15,"bold"),bg="white",fg="black").place(x=400,y=240,width=250)
       ...
       # while(run_val==1):
        ...
        passwrd = Label(frame1,text="Password",font=("times new roman",15,"bold"),bg="white",fg = "black").place(x=50,y=300)
        self.txt_passwrd = Entry(frame1,font=("times new roman",15),bg = "lightgray")
        self.txt_passwrd.place(x=50,y=330,width=250)
        
        conpasswrd = Label(frame1,text="Confirm Password",font=("times new roman",15,"bold"),bg="white",fg = "black").place(x=400,y=320)
        ...
        #   if(txt_passwrd==txt_conpasswrd):
         ...
         #terms check box
        self.var_chk=IntVar()
        chk=Checkbutton(frame1,text="I agree to terms and conditions",variable=self.var_chk, onvalue=1,offvalue=0).place(x=50,y=360)
          ...
          if self.txt_passwrd.get() !=  self.txt_conpasswrd.get():
            ...
            try:
                ...
                if row != None:
                    ...
                    cur.execute("insert into employee (f_name,l_name,contact,email,question,answe,password) values(%s,%s,%s,%s,%s,%s,%s)",(self.txt_fname.get(),self.txt_lname.get(),self.txt_con.get(),self.txt_mail.get(),self.drop_men.get(), self.txt_answer.get(),self.txt_passwrd.get())  )
                    con.commit()
                    con.close()
